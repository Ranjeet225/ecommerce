					...
					<ul class="list-unstyled components" id="accordion">
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
								<li>
									<a href="{{ route('vendor-prod-types') }}"><span>{{ __('Add New Product')
											}}</span></a>
								</li>
								<li>
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="affiliateprod" data-parent="#accordion">
								<li>
									<a href="{{ route('vendor-import-create') }}"><span>{{ __('Add Affiliate Product')
											}}</span></a>
								</li>
								<li>
									<a href="{{ route('vendor-import-index') }}"><span>{{ __('All Affiliate Products')
											}}</span></a>
								</li>
							</ul>
						</li>
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="general" data-parent="#accordion">
								...
								<li>
									<a href="{{ route('vendor-shipping-index') }}"><span>{{ __('Shipping Methods')
											}}</span></a>
								</li>


								<li>
									<a href="{{ route('vendor-package-index') }}"><span>{{ __('Packagings')
											}}</span></a>
								</li>


								<li>
									<a href="{{ route('vendor-pickup-point-index') }}"><span>{{ __('Pickup Point')
											}}</span></a>
								</li>
								...
								@endif
								<li>
									<a href="{{ route('vendor-sociallink-index') }}"><span>{{ __('Social Links')
											}}</span></a>
								</li>
							</ul>
						</li>
						<li>
							<a href="{{ route('vendor.income') }}" class="wave-effect"><i class="fas fa-eye mr-2"></i>
								{{ __('Total Earning') }}</a>
						</li>
					</ul>
				</nav>
