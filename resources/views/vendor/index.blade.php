    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg6">
                <div class="left">
                    ...
                    <span class="number">{{ App\Models\Product::vendorConvertPrice( auth()->user()->current_balance )
                        }}</span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    ...
                    <span class="number">{{ App\Models\Product::vendorConvertPrice($totalPrice)}}</span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-dollar-true"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg2">
                <div class="left">
                    @php
                    $totalPrice = $user->vendororders
                    ->where('status', 'completed')
                    ->sum(function ($order) {
                    return $order->price * $order->qty;
                    });
                    @endphp
                    <h5 class="title">{{ __('Pending Commission') }}</h5>
                    <span class="number">{{ App\Models\Product::vendorConvertPrice($user->admin_commission)}}</span>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-dollar-true"></i>
                        ...
                        <table id="pproducts" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-list"><a href="{{ route('vendor-prod-edit',$data->id) }}"><i
                        ...
                        <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-list"><a href="{{ route('vendor-order-show',$data->order_number) }}"><i class="fas fa-eye"></i> {{ __('Details') }}</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
