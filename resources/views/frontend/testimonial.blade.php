                  ...
                  <div class="col-md-6">
                     <div class="thumb-blog-horizontal clearfix hover-img-zoom transation mb-30">
                        ...
                        <div class="post-content ps-3">
                           ...
                           <h4 class="mb-2"><a href="{{ route('front.testimonialshow',$blog->slug) }}" class="transation text-dark hover-text-primary d-block">{{ mb_strlen($blog->title,'UTF-8') > 45 ? mb_substr($blog->title,0,45,'UTF-8')."..":$blog->title }}</a></h4>
